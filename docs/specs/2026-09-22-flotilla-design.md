...
| platforms | CI matrix Ubuntu + macOS × Python 3.11 / 3.12 / 3.13 (GitHub-hosted; `uv` provides each interpreter) | every commit — macOS is supported while its runner is green |
